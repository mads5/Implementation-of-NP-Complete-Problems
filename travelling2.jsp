...
<body>
<%String[] matrix=request.getParameterValues("ad"); %>
<%! int number_of_nodes; %>
<%number_of_nodes=matrix.length;%>
<!-- Navbar -->
<div class="w3-top">
...
<%!int len,p; %>
<%!int[][] mat; %>
<%len=(int)(Math.pow(number_of_nodes,0.5));
p=0;%>
 <%  mat=new int[len+1][len+1]; %>
 <%! int[] arr; %>
<%arr=new int[len]; %>
<%!int element, dst , i,numberOfNodes;%>
<%! boolean minFlag; %>
<%! int min; %>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  ...
  <%out.println("<h3>The cities are visited as follows</h3>"); %> <br>
    <% out.print("1");%>
    <%for(m=0;m<p;m++)
        	{
    	out.println(","+arr[m]);
